...
- [x] **Robust Content Acquisition Guidance:** Clearly inform users about limitations of URL fetching for bot-protected public sites and guide them to use the browser-context bookmarklet for higher success rates.
